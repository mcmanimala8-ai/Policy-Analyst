        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p className="text-xs uppercase tracking-widest text-muted-foreground mb-6">Tamil Nadu 2026: The Final Tally</p>
              <div className="space-y-3">
                <div className="flex items-center gap-4"><span className="text-sm text-muted-foreground w-28 shrink-0">TVK</span><div className="flex-1 bg-secondary h-7 overflow-hidden"><div className="bg-accent h-full flex items-center justify-end pr-2" style={{width:"46%"}}><span className="text-xs font-bold text-white">108</span></div></div></div>
                <div className="flex items-center gap-4"><span className="text-sm text-muted-foreground w-28 shrink-0">DMK Alliance</span><div className="flex-1 bg-secondary h-7 overflow-hidden"><div className="bg-blue-500 h-full flex items-center justify-end pr-2" style={{width:"31%"}}><span className="text-xs font-bold text-white">72</span></div></div></div>
                <div className="flex items-center gap-4"><span className="text-sm text-muted-foreground w-28 shrink-0">ADMK+NDA</span><div className="flex-1 bg-secondary h-7 overflow-hidden"><div className="bg-orange-500 h-full flex items-center justify-end pr-2" style={{width:"23%"}}><span className="text-xs font-bold text-white">54</span></div></div></div>
              </div>
              <p className="text-xs text-muted-foreground pt-4">Total seats: 234. Majority mark: 118. TVK fell 10 seats short. DMK alliance: DMK 59, INC 5, VCK 2, CPI 2, CPI(M) 2, IUML 2. ADMK+NDA: ADMK 47, PMK 4, BJP 1, DMDK 1, AMMK 1.</p>
          </div>
          ...
          <section>
            ...
            <p className="mt-4">From late 2025 onwards, TVK's digital infrastructure, widely reported across political and media circles, was said to include 34,000+ WhatsApp communities coordinated by young volunteers aged 19 to 35, trained in content sharing, emotional messaging, and fact-checking protocols. Their digital operation reportedly produced 120 to 150 pieces of vernacular video content daily, optimised for different platforms and demographic segments. Engineers and data scientists, reportedly sourced from consumer tech companies like Swiggy and PhonePe, were said to have built proprietary sentiment tracking tools. These figures were never officially confirmed by TVK, but the scale of the operation was visible enough that multiple regional parties have since approached former TVK digital operatives for consultation.</p>

    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-20 max-w-3xl mx-auto px-6 py-16">
        ...
        <article className="prose prose-invert prose-slate max-w-none
          ...
          prose-table:border-collapse prose-td:border prose-td:border-border prose-td:px-4 prose-td:py-2 prose-th:border prose-th:border-border prose-th:px-4 prose-th:py-2 prose-th:bg-muted
          prose-em:text-muted-foreground prose-em:text-sm
          ...
          <table>
            ...
            <tbody>
              <tr><td>Attendance</td><td>69.6%</td><td>79.2%</td></tr>
              <tr><td>Questions Asked</td><td>93</td><td>113</td></tr>
              <tr><td>Debates Participated</td><td>28</td><td>24</td></tr>
              <tr><td>Private Member Bills</td><td>3</td><td>0.2</td></tr>
              <tr><td>Performance Score</td><td>44/100</td><td>—</td></tr>
            </tbody>
          </table>
          <p>
          ...
          <p><em>Source: Unstarred Question No. 4809, Ministry of External Affairs, answered 28 March 2025; Zero Hour interventions 6 August 2024 and 7 February 2025; Calling Attention Rule 197, 1 April 2025.</em></p>

          <h3>Three Bills, One Day</h3>
          <p>
          ...
          <p><em>Source: Unstarred Question No. 3655, Ministry of Culture, answered 11 August 2025; Unstarred Question No. 3785, Ministry of Education, answered 24 March 2025.</em></p>

          <h3>Constituency Infrastructure</h3>
          <p>
          ...
          <p><em>Source: MPLADS Expenditure Data, Empowered Indian / Ministry of Statistics portal.</em></p>

          <h3>National Consumer and Rights Advocacy</h3>
          <p>
          ...
          <h2>What Kind of Parliamentarian</h2>
          <p>
            Kanimozhi is a <strong>structural critic</strong> — a parliamentarian who uses questions, bills, and debates not primarily to solve immediate problems but to construct and contest narratives in the public record. She operates on three distinct policy registers simultaneously.
          </p>
          <p>
            The first is <strong>federal equity</strong> — delimitation, concurrent list education grants, centrally sponsored scheme fund release, MBBS seat caps, semiconductor allocation to Tamil Nadu. Every one of these is an argument that the Centre's policies structurally disadvantage states that performed well on development indicators. The second is <strong>civilisational sovereignty</strong> — Keezhadi, manuscripts, three-language formula, Waqf Bill opposition. She uses Parliament to contest the dominant cultural narrative with a counter-narrative rooted in Tamil civilisational depth. The third is <strong>rights-based advocacy</strong> — death penalty abolition, climate change, salt workers welfare, gender pay gap, baby food regulation, SC/ST scholarship income ceiling.
          </p>
          <p>

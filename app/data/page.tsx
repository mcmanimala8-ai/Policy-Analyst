...
const sidebarLinks = [
  ...
  { href: "#education", label: "Education ledger" },
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border pt-28 pb-12">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-sm uppercase tracking-widest text-muted-foreground mb-4">Data Repository</p>
          ...
          <p className="text-muted-foreground max-w-3xl text-lg leading-relaxed">
            A growing public data repository for testing claims about Tamil Nadu's governance model. Each entry keeps success, failure, source notes, and data limits visible together.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-[240px_1fr] gap-10">
        ...
        <div className="space-y-10">
          <section id="overview" className="scroll-mt-28 border border-border bg-card p-6 md:p-8">
            ...
            <h2 className="font-serif text-3xl tracking-tight mb-4">What this page is for</h2>
            <p className="text-muted-foreground leading-relaxed max-w-3xl">
              This page is the single location for the site's data work. The homepage can preview charts, but this page should hold the repository: datasets, interpretation, drawbacks, and source trail.
            </p>
          </section>
          ...
          <section id="drawbacks" className="scroll-mt-28 border border-border bg-card p-6 md:p-8">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-3xl mb-6">
              ASER is best used as a warning light, not a final verdict. The limitations need to be visible because the repository is meant for public argument, not propaganda.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              {drawbacks.map((item) => (

            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0077B5] text-white text-sm font-medium hover:bg-[#005885] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 border border-border text-sm font-medium hover:border-accent hover:text-accent transition-colors"
                >
                  View Profile
                </a>
              </div>

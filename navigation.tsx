...
🔧 Quick fix — re-edit just navigation.tsx
Open: https://github.com/mcmanimala8-ai/Policy-Analyst/edit/main/components/navigation.tsx
Click in the editor → Ctrl+A (or Cmd+A on Mac) → Delete EVERYTHING
Paste the entire content below (this is the complete file — don't add or remove anything):
"use client"

      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>Another question rising within the left concerns Kanimozhi Karunanidhi's role, which was not projected well this time. Cadres of DMK are hoping to see Kanimozhi as the next leader for the party. The silence around succession is not just a party management question. It is a legitimacy gap. In a moment when DMK needs to rebuild its identity and its base, the absence of a clear next-generation narrative is itself a political choice, and not a neutral one.</p>
          </section>

...
const questions = [
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Tamil Nadu has a TFR of 1.8, one of the lowest in India and well below the replacement level of 2.1.",
  },
  {
    id: 3,
    ...
    correct: 1,
    explanation: "The Finance Commission determines how central taxes are shared between the Union and States. The 16th Finance Commission is deciding the formula for 2026-31.",
  },
  {
    id: 4,
    ...
    correct: 2,
    explanation: "The Social Security Code 2020 promised protections for gig and platform workers, including social security benefits and grievance mechanisms.",
  },
  {
    id: 5,
    ...
    correct: 1,
    explanation: "Subsidiarity means decisions should be made at the most local level possible, empowering local bodies rather than centralising power.",
  },
]
